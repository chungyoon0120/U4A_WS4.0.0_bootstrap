...
module.exports = (() => {
    ...
    const
        ...
        WS10_20 = PATH.join(APPPATH, "ws30", "ws10_20"),
    ...
    return {
        ...
        MAINFRAME: PATH.join(WS10_20, "index.html"),
        WS10: PATH.join(WS10_20, 'ws10_20.html'),
        EXTOPEN: PATH.join(WS10_20, 'extopen.html'),
        ERRORPAGE: PATH.join(WS10_20, 'errorpage.html'),
        ...
        U4A_HELP_DOC_ROOT: PATH.join(P13N_ROOT, "U4A_HELP_DOC")
